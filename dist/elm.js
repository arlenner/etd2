...
var author$project$Main$emptyTodo = {description: '', done: false, id: '', title: ''};
...
var author$project$Main$init = _Utils_Tuple2(
	{
		addingTodo: false,
		todoToAdd: author$project$Main$emptyTodo,
		todos: _List_fromArray(
			[
				{description: 'its my new favorite thing!', done: true, id: '0 - learn', title: 'Learn Elm'},
				{description: 'no giving up allowed.', done: false, id: '1 - start', title: 'Start My Front-End Dev Career'}
			])
	},
					...
					_Utils_update(
						model,
						{
							todos: A2(
								elm$core$List$map,
								function (td) {
									return _Utils_eq(td.id, i) ? {description: td.description, done: !td.done, id: td.id, title: td.title} : td;
								},
								model.todos)
						}),
					elm$core$Platform$Cmd$none);
			...
			case 'ChangeTitle':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							todoToAdd: {description: model.todoToAdd.description, done: false, id: model.todoToAdd.id, title: t}
						}),
					elm$core$Platform$Cmd$none);
			default:
				var d = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							todoToAdd: {description: d, done: false, id: model.todoToAdd.id, title: model.todoToAdd.title}
						}),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$Main$CancelTodoForm = {$: 'CancelTodoForm'};
var author$project$Main$StartTodoForm = {$: 'StartTodoForm'};
var author$project$Main$CheckTodo = function (a) {
	return {$: 'CheckTodo', a: a};
};
...
var lattyware$elm_fontawesome$FontAwesome$Icon$viewTitled = F5(
	function (attrs, transforms, title, outer, inner) {
		return A6(lattyware$elm_fontawesome$FontAwesome$Icon$viewWithId, inner.name, attrs, transforms, title, outer, inner);
	});
...
var lattyware$elm_fontawesome$FontAwesome$Solid$ban = A5(lattyware$elm_fontawesome$FontAwesome$Icon$Icon, 'fas', 'ban', 512, 512, 'M256 8C119.034 8 8 119.033 8 256s111.034 248 248 248 248-111.034 248-248S392.967 8 256 8zm130.108 117.892c65.448 65.448 70 165.481 20.677 235.637L150.47 105.216c70.204-49.356 170.226-44.735 235.638 20.676zM125.892 386.108c-65.448-65.448-70-165.481-20.677-235.637L361.53 406.784c-70.203 49.356-170.226 44.736-235.638-20.676z');
...
var author$project$Main$vTodo = function (td) {
	return A2(
		elm$html$Html$li,
		_List_fromArray(
			[
				...
				author$project$Main$CheckTodo(td.id))
			]),
		_List_fromArray(
			[
				A2(
				...
				td.done ? lattyware$elm_fontawesome$FontAwesome$Solid$checkCircle : lattyware$elm_fontawesome$FontAwesome$Solid$circle),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('li-preview')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(td.description)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(
						author$project$Main$ClearTodo(td.id))
					]),
				_List_fromArray(
					[
						A2(
...
var author$project$Main$getTodos = function (todos) {
	return A2(
		elm$html$Html$ul,
		_List_fromArray(
			[
		...
		A2(elm$core$List$map, author$project$Main$vTodo, todos));
};
var author$project$Main$AddTodo = F2(
	function (a, b) {
		return {$: 'AddTodo', a: a, b: b};
	});
var author$project$Main$ChangeDesc = function (a) {
...
var author$project$Main$vInput = F5(
...
var author$project$Main$vTodoForm = function (todo) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A5(author$project$Main$vInput, 'text', 'title', 'form-input', todo.title, author$project$Main$ChangeTitle),
				A5(author$project$Main$vInput, 'text', 'description', 'form-input', todo.description, author$project$Main$ChangeDesc),
				A2(
				elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$CancelTodoForm),
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								A2(author$project$Main$AddTodo, todo.title, todo.description)),
								elm$html$Html$Attributes$class('form-btn')
							]),
						_List_fromArray(
							[
								...
								_List_fromArray(
									[lattyware$elm_fontawesome$FontAwesome$Attributes$lg]),
								lattyware$elm_fontawesome$FontAwesome$Solid$checkCircle)
							]))
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('My To-Do List')
					])),
				model.addingTodo ? author$project$Main$vTodoForm(model.todoToAdd) : A2(
				elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_Nil),
				author$project$Main$getTodos(model.todos),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(
						model.addingTodo ? author$project$Main$CancelTodoForm : author$project$Main$StartTodoForm),
